...
print(paste('Top 10 median abundance taxa in',aux_diag,':'))
head(sort(aux_c_diag_colsum_median[aux_c_diag_colsum_median>0], decreasing = TRUE),n=aux_n)
print('----------------------------------------')
print(paste('Bottom 10 median abundance taxa in',aux_diag,':'))
...
print(paste0('Top 10 median abundance taxa in ',ifelse(aux_dysb=='T','','non-'),'dysbiotic:'))
head(sort(aux_c_dysb_colsum_median[aux_c_dysb_colsum_median>0], decreasing = TRUE),n=aux_n)
print('----------------------------------------')
print(paste0('Bottom 10 median abundance taxa in ',ifelse(aux_dysb=='T','','non-'),'dysbiotic:'))
